...
$file2           =$ARGV[1];  #track 2, list of DEGs
$file3           =$ARGV[2];  #track 3, all promoters
...
$cmd= "./area_shuffling_pair.exe	${file1}	chr_length_${ext_len}.txt	chr_name_${ext_nam}.txt	${file2}	${file3}	${iter}	${file_out_txt}	${file_out_dist}";
print "$cmd\n";
system $cmd;
