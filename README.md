...
Thus, for two pairs of tracks, first/second and first/third, two overlap lengths, two expected overlap lengths, two standard deviations, two Z-scores and two p-values are computed (Real12 and Real13, Av12 and Av13, p-value12, p-value13), and three total lengths of tracks L1, L2 and L3. We should check the hypothesis that ratios of overlap with the first track for the second and third tracks are equal: Real12/L2 == Real13/L3.
