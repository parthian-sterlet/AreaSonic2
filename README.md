...
Z-score = {Av12 / Real12 - Av13 / Real13} / SQRT{(σ12 * σ12) / (Real12 * Real12) + (σ13 * σ13) / (Real13 * Real13)}. 
...
Scheme1 of AreaSonic2 algorithm, permutation algorithm for a pair of tracks
![scheme](https://github.com/parthian-sterlet/AreaSonic2/blob/main/examples/AreaSonic21_github.png)

Scheme2 of AreaSonic2 algorithm, combination of three tracks: test of the significance of two track with respect to another track
